...
st.markdown("Le dataset utilisé pour ce graphique est la combinaison de 3 datasets : un par région observée (Monde, Héisphère Nord, Hémisphère Sud). <br>
Le dataset utilisé pour ce graphique est la combinaison de 3 datasets : un par région observée (Monde, Héisphère Nord, Hémisphère Sud). <br>
Les données représentent la différence entre la température moyenne de la surface de la mer et la moyenne de 1861 à 1890, en degrés Celsius, <br>
mesuré à une profondeur de 20 centimètres pour l'hémisphère Nord, l'hémisphère Sud et le monde. <br>
